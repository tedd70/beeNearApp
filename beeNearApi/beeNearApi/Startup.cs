...
namespace beeNearApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<BeeNearDbContext>(options =>
                                                      options.UseSqlServer(Configuration.GetConnectionString("beenear"))
                                                      );
